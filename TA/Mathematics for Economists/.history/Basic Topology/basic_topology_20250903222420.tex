...
\begin{frame}{Metric Spaces}
    ...
    \item Let $X$ be a metric space. All points and sets below are understood to be in $X$.
...
\bigskip
\textit{Note:} In $\mathbb{R}^1$ neighborhoods are open intervals, while in $\mathbb{R}^2$
neighborhoods are open disks (interiors of circles).
