...
Let us prove using a truth table and minterms.
...
\] 
are identical for all values of $P$ and $Q$.

\bigskip
\textbf{Minterm representation:}  
True for $(P=0,Q=1)$ and $(P=1,Q=0)$:
\[
(P \vee Q) \wedge \neg(P \wedge Q) = P'Q + PQ' = \neg(P \Leftrightarrow Q)
\]

Hence, the two compound statements are logically equivalent.
\end{frame}
