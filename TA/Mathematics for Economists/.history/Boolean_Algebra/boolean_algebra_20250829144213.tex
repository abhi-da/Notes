...
\begin{frame}{Step 1: Truth table for biconditional}
Let $P$ and $Q$ be statements. Consider the biconditional $P \Leftrightarrow Q$.
...
\begin{frame}{Step 2: Identify minterms for TRUE outputs}
...
\medskip
Minterms corresponding to TRUE outputs:

\[
P'Q' \quad \text{and} \quad PQ
\]
...
\[
P \Leftrightarrow Q = P'Q' + PQ
\]
\end{frame}

\begin{frame}{Step 3: Negation of biconditional (XOR form)}
Negating the biconditional:

\[
\neg(P \Leftrightarrow Q) = (P'Q' + PQ)'
\]

Apply De Morgan's law:

\[
\neg(P \Leftrightarrow Q) = (P'Q')' \cdot (PQ)' = (P + Q) \cdot (P' + Q')
\]

Distribute if desired:
...
\medskip
\alert{Thus, the negation of a biconditional is the XOR of $P$ and $Q$.}
\end{frame}
