...
\begin{frame}{For statements $P$ and $Q$, show that $P \Rightarrow (P \vee Q)$ is a tautology}
...
\alert{Thus, $P \Rightarrow (P \vee Q)$ is always true, so it is a tautology.}
\end{frame}
