...
\begin{frame}{For statements $P$ and $Q$, show that $(P \wedge (P \Rightarrow Q)) \Rightarrow Q$ is a tautology (1)}
Convert to Boolean expression using $A \Rightarrow B = A' + B$:
\[
...
\begin{frame}{For statements $P$ and $Q$, show that $(P \wedge (P \Rightarrow Q)) \Rightarrow Q$ is a tautology (2)}
Use Complement Law on $(P' + P)$:
\[
1 \cdot (P' + Q') + Q = P' + Q' + Q
\]

Use Complement Law on $(Q'+Q)$:
\[
P' + 1
\]

Use Annulment Law ($X + 1 = 1$):
\[
1
\]

\alert{Hence, $(P \wedge (P \Rightarrow Q)) \Rightarrow Q$ is always true, so it is a tautology.}
\end{frame}



\begin{frame}{Show that $[(P \vee Q) \wedge \neg(P \wedge Q)] \equiv \neg(P \Leftrightarrow Q)$}
First, derive the RHS using the bi-conditional definition:  
\[
P \Leftrightarrow Q \equiv PQ + P'Q' \implies \neg(P \Leftrightarrow Q) \equiv (PQ + P'Q')' 
\]

Using De Morgan's Law:
\[
\neg(P \Leftrightarrow Q) = (PQ)' \cdot (P'Q')' = P' + Q' \cdot ?
\]

Alternatively, using **minterms**, $\neg(P \Leftrightarrow Q)$ is true when $P$ and $Q$ differ:  
\[
\neg(P \Leftrightarrow Q) = PQ' + P'Q
\]
...
Apply De Morgan's Law to the complement:
\[
(P + Q)(P' + Q')
\]
...
Apply Complement Law ($PP' = 0$, $QQ' = 0$):
\[
PQ' + P'Q
\]

\alert{Hence, LHS = RHS, and the compound statements are logically equivalent.}
\end{frame}
