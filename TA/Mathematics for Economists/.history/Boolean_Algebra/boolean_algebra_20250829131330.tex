...
\section{For statements $P$ and $Q$, show that $P \Rightarrow (P \vee Q)$ is a tautology}

To prove this, first let us convert the implication into sum and product logical operators.  
We know that $A \Rightarrow B$ is logically equivalent to $A' + B$, that is, \emph{not $A$ or $B$}.  

Using this, we can write:
\[
P \Rightarrow (P \vee Q) \equiv P' + (P \vee Q)
\]

Now, using the associative law:
\[
P' + (P \vee Q) = (P' + P) \vee Q
\]
...
Thus, $P \Rightarrow (P \vee Q)$ is always true, so it is a \textbf{tautology}.
