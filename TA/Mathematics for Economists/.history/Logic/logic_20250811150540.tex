...
\begin{frame}{Implications (Conditional)}
    The statement or open sentence $P$ in the implication $P \Rightarrow Q$ is commonly referred to as the \textbf{hypothesis} or \textbf{premise} of $P \Rightarrow Q$, while $Q$ is called the \textbf{conclusion} of $P \Rightarrow Q$.\\begin{align*}
