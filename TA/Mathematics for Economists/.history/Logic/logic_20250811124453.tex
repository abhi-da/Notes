...
\begin{frame}{Conjunctions and Disjunctions}
    \begin{itemize}
    ...
    \item For example, P: The integer 10 is even, Q: 5 is the cube root of 25. Here P is true and Q is false. The discunjunction statement would be P$\lor$Q, which we would read, Either "The integer 10 is even" or "5 is a cube root of 25". And this discunjunction statement is true, cause P is true. 
    \end{itemize}
\end{frame}
