...
\begin{frame}{Tautologies and Contradictions}
    \begin{enumerate}
        ...
        \item A compound statement $S$ is called a \textbf{contradiction} if it is false for all possible combinations of truth values of the component statements that are used to form $S$. The statement $P \land (\sim P)$ is a contradiction. If a compound statement $S$ is a tautology, then its negation $\sim S$ is a contradiction.
    \end{enumerate}
\end{frame}
